package ru.urfu.test_security2db_themeleaf.controller;
...
import ru.urfu.test_security2db_themeleaf.service.UserService;
    ...
    public String registration(@Valid @ModelAttribute("user") UserDto userDto,
        ...
        if(existingUser != null && existingUser.getEmail() != null && !existingUser.getEmail().isEmpty()){
            result.rejectValue("email", null,
                    "Ha этот адрес электронной почты уже зарегистрирована учётная запись.");
        }
